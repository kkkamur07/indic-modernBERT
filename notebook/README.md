...
- **2 — Data** — pretokenization + parquet + production DataLoaders (raw / packed / eval); mmap row-group reads ([`LEARNINGS.md`](../docs/LEARNINGS.md) § Parquet DataLoader memory fixes)
